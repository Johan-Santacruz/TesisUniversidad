...
ANALYSIS_INSTRUCTIONS = (
    ...
    "\n\n"
    "CLAVES OBLIGATORIAS. Estas cinco 'key' son fijas y el sistema las usa por "
    "su nombre exacto: 'people' (quiénes componen el hogar), "
    "'current_location' (dónde está ahora), 'origin_location' (de dónde "
    "salió), 'places' (otros lugares del relato) y 'vulnerabilities' (quiénes "
    "necesitan protección especial; su value es una lista elegida SÓLO entre "
    "'children', 'older_adults', 'pregnancy', 'disability' e 'illness', o "
    "la lista con 'none' si el relato dice expresamente que no hay nadie en "
    "esas situaciones). Emítelas SIEMPRE "
    ...
    "\n\n"
    "NO CALIFIQUES LA URGENCIA. No emitas ninguna señal que gradúe qué tan "
    "urgente es la atención o qué tan alto es el riesgo del caso: el sistema "
    "no la usa para orientar y sólo le suma una tarjeta más a quien revisa."
    "\n\n"
